...
set CLASSPATH=%APP_HOME%\lib\example.jar;%APP_HOME%\lib\json-20090211.jar;%APP_HOME%\lib\postgresql-9.4.1208-jdbc42-atlassian-hosted.jar

@rem Execute example
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXAMPLE_OPTS%  -classpath "%CLASSPATH%" com.rick.Main %CMD_LINE_ARGS%
